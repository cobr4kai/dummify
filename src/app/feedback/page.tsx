            ...
            <form action={submitFeedbackAction} className="space-y-5">
              ...
              <fieldset className="space-y-2.5">
                ...
                <div className="grid gap-3 sm:grid-cols-2">
                  <label className="relative cursor-pointer rounded-[22px] border p-3.5 transition hover:border-[rgba(214,198,167,0.32)] hover:bg-[rgba(255,248,235,0.05)] has-[:checked]:border-[#D6C6A7] has-[:checked]:bg-[rgba(214,198,167,0.14)] has-[:checked]:ring-2 has-[:checked]:ring-[rgba(214,198,167,0.22)] has-[:checked]:shadow-[0_0_0_1px_rgba(214,198,167,0.32)] border-[rgba(214,198,167,0.18)] bg-[rgba(255,248,235,0.03)]">
                    <input className="peer sr-only" name="sentiment" type="radio" value="USEFUL" />
                    <span className="flex items-center justify-between gap-3 text-sm font-semibold text-[#E7D9BC] peer-checked:text-[#FFF7E8]">
                      <span>Yes</span>
                      <span className="flex h-5 w-5 items-center justify-center rounded-full border border-[rgba(214,198,167,0.22)] bg-transparent text-[11px] text-transparent transition peer-checked:border-[#D6C6A7] peer-checked:bg-[#D6C6A7] peer-checked:text-[#1A1510]">
                        ✓
                      </span>
                    </span>
                    <span className="mt-1 block text-sm leading-6 text-[#B8AA8B] peer-checked:text-[#F0DFC0]">
