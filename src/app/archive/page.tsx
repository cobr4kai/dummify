    ...
    >
      ...
      {papers.length === 0 ? (
        <EmptyState
          ...
          description="Try loosening the search terms or switching to a different week or category."
          guidance="Broader keywords usually work best here. If you were looking for a specific paper, try its main topic, category, or arXiv ID."
        />
      ) : (
